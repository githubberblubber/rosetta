...
/// @brief BootCampMover class can construct a fold tree from DSSPand introduce cutpoints for loop closure solvers.
...
/// @brief This mover is unpublished.  It returns jonwu as its author.
void
